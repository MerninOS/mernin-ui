...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border-[2px] border-espresso px-3 py-0.5 text-[0.65rem] font-bold uppercase tracking-[0.1em] transition-colors focus:outline-none focus:ring-2 focus:ring-tomato focus:ring-offset-2",
  {
    variants: {
      variant: {
